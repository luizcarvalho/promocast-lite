...
# attack on all your stupid useres' passwords.  With a site key, we store
...
# otherwise place it in public view you'll kinda defeat the point.  Your useres'
# passwords are still secure, and the world won't end, but defense_in_depth -= 1.
# 
# Please note: if you change this, all the passwords will be invalidated, so DO
# keep it someplace secure.  Use the random value given or type in the lyrics to
# your favorite Jay-Z song or something; any moderately long, unpredictable text.
REST_AUTH_SITE_KEY         = '61527761e267ae627c3b7bdd2337ab1ba11b9d9a'
