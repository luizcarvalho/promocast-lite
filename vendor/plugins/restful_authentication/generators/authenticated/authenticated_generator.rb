...
class AuthenticatedGenerator < Rails::Generator::NamedBase
  ...
  attr_reader   :model_controller_name,
                ...
                :model_controller_routing_path,           # /useres/new
                :model_controller_controller_name         # useres
  ...
  def manifest
    recorded_session = record do |m|
      ...
      if @rspec
        # RSpec Specs
        m.template  'spec/controllers/useres_controller_spec.rb',
        ...
        m.template  'spec/helpers/useres_helper_spec.rb',
        ...
        m.template  'spec/models/user_spec.rb',
                    File.join('spec/models',
                              class_path,
                              "#{file_name}_spec.rb")
        m.template 'spec/fixtures/useres.yml',
    ...
    when "generate"
      ...
      if $rest_auth_site_key_from_generator.blank?
        puts "You've set a nil site key. This preserves existing useres' passwords,"
