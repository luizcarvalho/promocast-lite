class ProgramasController < ApplicationController
  ...
  def index
      ...
      @programas = @search.all.paginate(:page => params[:page])
  ...
  def create
    ...
    respond_to do |format|
      if @programa.save
        format.html { redirect_to(@programa, :notice => 'Programa foi criado com sucesso!') }
  ...
  def update
    ...
    respond_to do |format|
      if @programa.update_attributes(params[:programa])
        format.html { redirect_to(@programa, :notice => 'O programa foi alterado com sucesso!') }
        format.xml  { head :ok }
      else
